<div>
    ...
    <div class="space-y-4 px-8 py-6">
        ...
        <x-input.label label="Jira Domain">
            <x-input.text type="url" wire:model="domain" placeholder="https://your-team.atlassian.net" class="font-medium" />
        </x-input.label>

        <x-input.label label="Email">
            <x-input.text type="email" wire:model="email" placeholder="you@example.com" class="font-medium" />
        </x-input.label>

        <x-input.label label="API Token">
            <x-input.text type="password" wire:model="apiToken" placeholder="Your Jira API token" class="font-medium" />
        </x-input.label>
