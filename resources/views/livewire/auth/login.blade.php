<div>
    ...
    <form wire:submit="login" class="mt-6 space-y-4">
        ...
        <button type="submit" class="w-full rounded-lg bg-accent-600 px-4 py-2.5 text-sm font-medium text-white shadow-sm hover:bg-accent-700 transition-colors">Sign in</button>
    </form>
